...
class ObjectStore {
  public:
    static auto
    store_object(const std::string& raw_data) -> std::expected<std::string, std::string>;
    ...
    static auto compress(const std::string& data) -> std::expected<std::string, std::string>;
    static auto
